...
"""autogenerated by genpy from bspline/Bspline.msg. Do not edit."""
import codecs
import sys
...
class Bspline(genpy.Message):
  _md5sum = "4f7510f7be6fba2868a5e74dd6e8163b"
  _type = "bspline/Bspline"
...
float64 z
"""
  __slots__ = ['drone_id','order','traj_id','start_time','knots','pos_pts','yaw_pts','yaw_dt']
  _slot_types = ['int32','int32','int64','time','float64[]','geometry_msgs/Point[]','float64[]','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       drone_id,order,traj_id,start_time,knots,pos_pts,yaw_pts,yaw_dt
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2iq2I().pack(_x.drone_id, _x.order, _x.traj_id, _x.start_time.secs, _x.start_time.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_id, _x.order, _x.traj_id, _x.start_time.secs, _x.start_time.nsecs,) = _get_struct_2iq2I().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2iq2I = None
def _get_struct_2iq2I():
    global _struct_2iq2I
    if _struct_2iq2I is None:
        _struct_2iq2I = struct.Struct("<2iq2I")
    return _struct_2iq2I
_struct_3d = None
def _get_struct_3d():
    global _struct_3d
