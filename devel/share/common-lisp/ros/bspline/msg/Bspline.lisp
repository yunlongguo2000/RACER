...
(cl:defmethod cl:initialize-instance :after ((m <Bspline>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bspline)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bspline-msg:<Bspline> is deprecated: use bspline-msg:Bspline instead.")))

(cl:ensure-generic-function 'drone_id-val :lambda-list '(m))
(cl:defmethod drone_id-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bspline-msg:drone_id-val is deprecated.  Use bspline-msg:drone_id instead.")
  (drone_id m))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bspline-msg:order-val is deprecated.  Use bspline-msg:order instead.")
  (order m))

(cl:ensure-generic-function 'traj_id-val :lambda-list '(m))
(cl:defmethod traj_id-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bspline-msg:traj_id-val is deprecated.  Use bspline-msg:traj_id instead.")
  (traj_id m))
...
(cl:defmethod knots-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bspline-msg:knots-val is deprecated.  Use bspline-msg:knots instead.")
  (knots m))

(cl:ensure-generic-function 'pos_pts-val :lambda-list '(m))
(cl:defmethod pos_pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bspline-msg:pos_pts-val is deprecated.  Use bspline-msg:pos_pts instead.")
  (pos_pts m))

(cl:ensure-generic-function 'yaw_pts-val :lambda-list '(m))
(cl:defmethod yaw_pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bspline-msg:yaw_pts-val is deprecated.  Use bspline-msg:yaw_pts instead.")
  (yaw_pts m))

(cl:ensure-generic-function 'yaw_dt-val :lambda-list '(m))
(cl:defmethod yaw_dt-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bspline-msg:yaw_dt-val is deprecated.  Use bspline-msg:yaw_dt instead.")
  (yaw_dt m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Bspline>)))
  ...
  "4f7510f7be6fba2868a5e74dd6e8163b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Bspline)))
  "Returns md5sum for a message object of type 'Bspline"
  "4f7510f7be6fba2868a5e74dd6e8163b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Bspline>)))
  ...
  (cl:format cl:nil "int32 drone_id~%~%int32 order~%int64 traj_id~%time start_time~%~%float64[] knots~%geometry_msgs/Point[] pos_pts~%~%float64[] yaw_pts~%float64 yaw_dt~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Bspline)))
  "Returns full string definition for message of type 'Bspline"
  (cl:format cl:nil "int32 drone_id~%~%int32 order~%int64 traj_id~%time start_time~%~%float64[] knots~%geometry_msgs/Point[] pos_pts~%~%float64[] yaw_pts~%float64 yaw_dt~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
